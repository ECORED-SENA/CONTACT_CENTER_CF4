  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-principal
      .titulo-principal__numero
        span 7
      h1 Terminología y vocabulario propio del <i>Contact Center</i> BPO

    .contenedor-total
      .contenedor-imagen
        figure
          img.mx-auto(src='@/assets/curso/tema7/img1.png' alt='Imagen ambiental' style='')
      .contenedor-text
        .row.mb-4.mb-lg-4
          .col-auto
            p.mb-0 Cuando se trabaja o labora en operaciones de <i>Contact Center</i> BPO, es fácil notar cómo estas operaciones manejan su propia terminología y vocabulario que a simple vista no son fáciles de comprender; por ello se invita a conocer el vocabulario más utilizado en la industria.
        
    .tabla-b.color-primario.mb-5
      table
        thead(style='background-color: #3E2EA6')
          tr
            th.text-white(style="width: 25%; border-right: 0")
              h3.mb-0 T&eacute;rmino
        ...
        tbody
          ...
          tr
            ...
            td
              | Aquellas personas que contestan las llamadas en un Centro de Llamadas. Se encargan no solo de contestar las llamadas, tambi&eacute;n tienen la capacidad de asesorar y atender cualquier inquietud de los usuarios. Atienden o emiten contactos siguiendo m&eacute;todos de trabajo con actuaciones protocolizadas, y recepciones llamadas para la prestaci&oacute;n o atenci&oacute;n de cualesquiera servicios.
          tr
            th 
              h4.mb-0 Ani
            td
          ...
          tr
            th 
              h4.mb-0 Turno
            td
              | Horario estipulado por el o los supervisores de acuerdo con la necesidad de cada campa&ntilde;a (ma&ntilde;ana, tarde-noche, madrugada).
          tr
            th 
              h4.mb-0 Turno rotativo
            td
              | Horarios cambiantes para los analistas de servicio al cliente dependiendo de las necesidades de cada campa&ntilde;a.
          tr
            th
              h4.mb-0 Coordinador o supervisor
            td
              | Es aquel trabajador que tiene encomendada y realiza la coordinaci&oacute;n de un grupo de teleoperadores o gestores, responsabiliz&aacute;ndose del desarrollo del trabajo de este en la totalidad de las actividades y procesos de la campa&ntilde;a o servicio a la que est&eacute; adscrito el grupo, aplicando procedimientos y normas establecidas, recibiendo supervisi&oacute;n sobre el trabajo y sus resultados.
          tr
            th 
              h4.mb-0 Formador o capacitador
            td
              | Es aquel trabajador encargado de impartir los cursos formativos para la capacitaci&oacute;n del personal de operaciones.
          tr
            th 
              h4.mb-0 Agente de calidad (quality)
            td
              | Es aquel trabajador encargado de efectuar el control de calidad de las tareas realizadas por teleoperadores y gestores.
          tr
            th 
              h4.mb-0 Diadema
            td
              | Dispositivo auricular y bocina que permite la comunicaci&oacute;n telef&oacute;nica a manos libres.
          tr
            th 
              h4.mb-0 Crm
            td
          ...
          tr
            ...
            td
              | Capacidad del distribuidor ACD que combina las necesidades espec&iacute;ficas de un cliente con una agente que cuenta con las habilidades necesarias para atender la llamada en tiempo real.
          tr
            th 
              h4.mb-0 Tiempo de conexi&oacute;n
            td
              | Tiempo total y real desde que el analista recibe la primera llamada hasta la &uacute;ltima dentro de un turno.
          tr
            th 
              h4.mb-0 Tipificaciones
            td
              | Palabra o palabras que resumen el motivo de la llamada, permitiendo medir productividad y sacar indicadores de la gesti&oacute;n.
          tr
            th 
              h4.mb-0 Soluci&oacute;n en primer punto de contacto
            td
              | Lograr concluir el objetivo de la llamada sin tener que realizar una segunda llamada, para tal fin, de tal manera que el cliente se convierta en fans de la compa&ntilde;&iacute;a.
          tr
            th 
              h4.mb-0 Dimensionamiento
            td
          ...
          tr
            ...
            td Labor espec&iacute;fica para la que es contratado el centro.
          tr
            th 
            ...
            td
              ...
              br
              | Previa (selecci&oacute;n del agente).
              br
              | Progresiva (sin condiciones, utiliza IVR).
              br
              | Autom&aacute;tica (espera agente disponible).
          tr
            th 
              h4.mb-0 Monitoreo en l&iacute;nea agentes y llamadas &ndash; CMS / Avaya
            td
              | Es una de las herramientas fundamentales en la gesti&oacute;n diaria del personal de supervisi&oacute;n de calidad que permite un monitoreo permanente en tiempo real del estado actual de cada agente.
          tr
            th 
              h4.mb-0 Servicios de VOIP (voz ip)
            td
              | Red de telefon&iacute;a IP a nivel nacional que nos permite ofrecer servicios de interconexi&oacute;n telef&oacute;nica entre estas ciudades a trav&eacute;s de la red a un costo similar al de una llamada local y transmitir esta reducci&oacute;n de costos a nuestros clientes.
          tr
            th 
              h4.mb-0 Protocolo
            td
              | Guion establecido para una campa&ntilde;a de manera obligatoria se da al inicio y al final de cada llamada implica saludo, presentaci&oacute;n de la empresa, presentaci&oacute;n del agente.
